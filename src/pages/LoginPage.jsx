  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h1 style={{ color: 'white', fontSize: 28, marginBottom: 12 }}>Willkommen zurück</h1>
        <p style={{ color: 'rgba(255,255,255,0.5)', fontSize: 15, lineHeight: 1.6 }}>
          Melde dich an um auf das Feuerwehr-Organisationstool zuzugreifen.
        </p>

        <div style={{ marginTop: 48, padding: '20px', background: 'rgba(255,255,255,0.06)', borderRadius: 8 }}>
          <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.4)', marginBottom: 8 }}>Noch kein Konto?</div>
          <Link to="/registrieren" style={{ color: 'var(--red)', fontWeight: 500, fontSize: 14 }}>
            Jetzt registrieren →
          </Link>
        </div>
      </div>
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 48 }}>
        <div style={{ width: '100%', maxWidth: 380 }}>
          ...
          <p style={{ marginBottom: 32, color: 'var(--gray-400)', fontSize: 14 }}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button type="submit" className="btn btn-primary btn-lg" style={{ width: '100%', justifyContent: 'center', marginTop: 8 }} disabled={loading}>
              {loading ? <><span className="spinner" style={{ width: 16, height: 16, borderWidth: 2 }}></span> Laden...</> : 'Anmelden'}
            </button>
          </form>
        </div>
      </div>
