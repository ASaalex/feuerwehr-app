...
Keine Aufgaben im Innenangriff oder Schlauchmanagement.`,
    ...
    if (istWissensModus) {
      ...
      const wissenSystemText = [
        ...
        regelwerkeGeladen
          ? [
              "WICHTIG – GENAUIGKEITSREGELN (alle zwingend einhalten):",
              "",
              "1. FUNKTIONEN NIEMALS VERWECHSELN: Wenn im Text 'Gruppenführer' steht, schreibe 'Gruppenführer'.",
              "   Wenn 'Wassertrupp' steht, schreibe 'Wassertrupp'. Übertrage Tätigkeiten NIEMALS auf eine andere Funktion.",
              "   Beispiel: 'Der Gruppenführer erkundet' darf NICHT zu 'Der Angriffstruppführer erkundet' werden.",
              "",
              "2. NUR AUS DEM TEXT: Schreibe ausschließlich was im bereitgestellten Vorschriftentext steht.",
              "   Ergänze oder schlussfolgere NICHTS was nicht explizit im Text steht.",
              "",
              "3. WORTGETREUE ZITATE: Zitiere die entscheidenden Sätze so nah am Original wie möglich.",
              "   Behalte dabei die exakten Funktionsbezeichnungen aus dem Originaltext bei.",
              "",
              "4. ALLE RELEVANTEN ABSCHNITTE: Lies alle bereitgestellten Abschnitte (5.5.1, 5.5.2, 5.5.3 usw.)",
              "   und nenne jeden mit seiner exakten Nummer im Feld VORSCHRIFT.",
            ].join("\n")
        ...
        "✅ ANTWORT: [Aufzaehlung der Aufgaben aus ALLEN relevanten Abschnitten.",
        "   Beginne jeden Punkt mit der exakten Funktionsbezeichnung aus dem Text, z.B. '- Wassertrupp: ...'.",
        "   Zitiere die entscheidenden Saetze wortgetreu in Anfuehrungszeichen.]",
        "💡 HINWEIS: [Nur wenn der Text ausdruecklich ergaenzende Informationen enthaelt – sonst weglassen]",
        "",
        "Halte die Antwort praxisorientiert und praezise. Verwechsle NIEMALS Funktionen.",
        regelwerkeText,
      ].join("\n");
      ...
      const statischerText = [
        ...
        "📖 VORSCHRIFT: [Dokument + Abschnitt auf EINER Zeile, kein Zeilenumbruch! Beispiel: FwDV 3 Abschnitt 5.5.1]",
        "▶ SITUATION: [Naechste Einsatzsituation und Frage]",
        "",
        "WICHTIG fuer das Format:",
        "- Jede Zeile beginnt mit dem Emoji-Prefix. Kein Zeilenumbruch innerhalb einer Zeile!",
        "- 📖 VORSCHRIFT muss Dokument UND Abschnittsnummer enthalten, alles hinter dem Doppelpunkt auf einer Zeile.",
        "  Richtig:  '📖 VORSCHRIFT: FwDV 3 Abschnitt 5.5.1'",
        "  Falsch:   '📖 VORSCHRIFT:\\nFwDV 3 Abschnitt 5.5.1'",
        "",
        "Regeln:",
